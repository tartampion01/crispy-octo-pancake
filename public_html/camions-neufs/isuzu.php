                        ...
                        <ul class="GpcMenu FacetedNavigation">
                            ...
                            <li class="GpcMenuCategory expanded">
                                ...
                                <ul class="marque" style="">
                                    <?PHP $results = selectNewTrucksDisctinctCriteria('marque', ' marque="isuzu" AND ', 'COUNT', 'DESC' ); ?>
                                        <?PHP foreach($results as $key => $value){ ?>
                                        <li class="GpcMenuItem filter-link" data-field='marque' data-value='<?PHP echo $key ?>' data-custom-criteria=' marque="isuzu" AND ' data-selected="false">
                            ...
                            <li class="GpcMenuCategory expanded">
                                ...
                                <ul class="Model" style="">
                                    <?PHP $results = selectNewTrucksDisctinctCriteria('Model', ' marque="isuzu" AND ', 'Model', 'ASC'); ?>
                                        <?PHP foreach($results as $key => $value){ ?>
                                        <li class="GpcMenuItem filter-link" data-field='Model' data-value='<?PHP echo $key ?>' data-custom-criteria=' marque="isuzu" AND ' data-selected="false">
                            ...
                            <li class="GpcMenuCategory expanded">
                                ...
                                <ul class="transtype" style="">
                                    <?PHP $results = selectNewTrucksDisctinctCriteria('transtype', ' marque="isuzu" AND ', 'transtype', 'ASC'); ?>
                                        <?PHP foreach($results as $key => $value){ ?>
                                        <li class="GpcMenuItem filter-link" data-field='transtype' data-value='<?PHP echo str_replace('+', '%2B', $key) ?>' data-custom-criteria=' marque="isuzu" AND ' data-selected="false">
                            ...
                            <li class="GpcMenuCategory expanded">
                                ...
                                <ul class="engine" style="">
                                    <?PHP $results = selectNewTrucksDisctinctCriteria('engine', ' marque="isuzu" AND ', 'engine', 'ASC'); ?>
                                        <?PHP foreach($results as $key => $value){ ?>
                                        <li class="GpcMenuItem filter-link" data-field='engine' data-value='<?PHP echo $key ?>' data-custom-criteria=' marque="isuzu" AND ' data-selected="false">
