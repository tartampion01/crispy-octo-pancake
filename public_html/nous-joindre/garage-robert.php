...
<?php $suc = new RD_Succursales(); $suc->load(nomSuccursale::Shawinigan); ?>
                                ...
                                <?php foreach($suc->contacts as $contact):
                                    foreach($contact as $details):?> 
                                        ...
                                        <p><?php echo $details[1]; ?></br>
                                            <a href='mailto:<?php if(count($details)>2) echo $details[2]; ?>'><?php if(count($details)>2) echo $details[2]; ?></a>
                                        </p>
