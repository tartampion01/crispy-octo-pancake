                        ...
                        <div class="menuCss4">
                            <ul>
                                ...
                                <li class="rank6 parent">
                                    <a href="<?php echo RD_PageLink::getHref(folder::PiecesService,page::PiecesEtServicesFinancement); ?>" class="rank1">Pièces et services</a>
                                    <div class="itemChildDiv5">
                                        <ul class="itemChild5">
                                            <li class="first rank0">
                                ...
                                <li class="rank9 parent">
                                    <a href="<?php echo RD_PageLink::getHref(folder::PromotionsNouvelles,page::PromotionsEtNouvellesPromotions); ?>" class="rank9">Promotions et nouvelles</a>
                                    <div class="itemChildDiv14">
                                        <ul class="itemChild14">
                                            <li class="first rank0">
                                                <a href="<?php echo RD_PageLink::getHref(folder::PromotionsNouvelles,page::PromotionsEtNouvellesPromotions); ?>" class="first rank0">Promotions</a>
                                            </li>
                                            <li class="rank1">
                                                <a href="<?php echo RD_PageLink::getHref(folder::PromotionsNouvelles,page::PromotionsEtNouvellesNouvelles); ?>" class="rank1">Nouvelles</a>
                                            </li>
                                            <li class="rank2">
                                                <a href="<?php echo RD_PageLink::getHref(folder::PromotionsNouvelles,page::PromotionsEtNouvellesConcours); ?>" class="rank2">Concours</a>
                                            </li>
                                            <li class="last rank3">
                                                <a href="<?php echo RD_PageLink::getHref(folder::PromotionsNouvelles,page::PromotionsEtNouvellesPromoPieces); ?>" class="last rank3">Promo pièces</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
