            ...
            <div class="shrink">
                ...
                <div class="contenu">
                    <div class="contenu2">
                        ...
                        <p><a class="btnOrange" name="hyperlien" href="<?php RD_PageLink::getHref(folder::Root,page::Fournisseurs) ?>">Nos fournisseurs</a></p>
                        ...
                        <p>Commandez rapidement vos pièces en ligne avec notre outil de commande NextPart ou composez le numéro de téléphone de 
                            <a name="hyperlien" href="<?php RD_PageLink::getHref(folder::Root,page::NousJoindre) ?>">votre succursale </a>
                             et un des techniciens du département des pièces de Réseau Dynamique vous aidera à trouver ce dont vous avez besoin.</p>
                        <p>
                            <a class="btnOrange" name="hyperlien" href="<?php RD_PageLink::getHref(folder::EXTERNAL,page::EXTERNAL_fleetrite) ?>">Nos pièces Fleetrite</a>
                            <a class="btnOrange" name="hyperlien" href="<?php RD_PageLink::getHref(folder::Nextpart,page::InscriptionNextPart) ?>">S'inscrire à NextPart</a>
                            <a class="btnOrange" name="hyperlien" href="<?php RD_PageLink::getHref(folder::Root,page::NousJoindre) ?>">Contactez votre succursale</a>
                        </p>
                        <h2>Accessoires</h2>
                        ...
                        <p>Réseau Dynamique comprend les conséquences d'un problème routier sur votre entreprise. C'est pourquoi vous pouvez faire appel au 
                            <a name="hyperlien" href="<?php RD_PageLink::getHref(folder::PiecesService,page::PiecesEtServicesServiceRoutier) ?>">Service routier </a>
                            pour toute réparation mineure partout au Québec.</p>
                        <p>
                            <a name="hyperlien" href="<?php RD_PageLink::getHref(folder::Root,page::NousJoindre) ?>">Prenez rendez-vous </a>
